...
<input type="text" class="text_field text_field_big" placeholder="Ваш email" name="login_email">
</div>
</div>
...
<div class="form_big_section_body">
<input type="text" class="text_field text_field_big" placeholder="Ваш пароль" name="login_password">
</div>
</div>
...
<div class="form_big_section_body">
<input type="submit" class="button" name="login_submit">
</div>
</div>
</FORM>
